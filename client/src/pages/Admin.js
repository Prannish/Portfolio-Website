...
const Admin = () => {
  ...
  const handleCertSubmit = async (e) => {
    ...
    Object.keys(certData).forEach((key) => {
      if (certData[key]) formData.append(key, certData[key]);
    });
    try {
      ...
      <div className="admin-section">
            ...
            {currentResume ? (
              <>
                ...
                <button
                  ...
                  onClick={() => window.open(`${API_BASE_URL}/resume/download`)}
                >
                  Download
                </button>
        ...
        {activeTab === "projects" && (
          <div className="section">
            ...
            <p>{projectMessage}</p>
            <h2 style={{ marginTop: "20px" }} align="center">
              Your Projects
            </h2>
            {projects.map((proj) => (
              <div
              ...
              >
                ...
                {proj.hasImage && (
                  <img
                    src={
                      proj.imageUrl ||
                      `${API_BASE_URL}/projects/${proj._id}/image`
                    }
                    alt={proj.title}
          ...
          <div className="section">
            ...
            <form onSubmit={handleCertSubmit}>
              ...
              <input
                ...
                onChange={(e) =>
                  setCertData({ ...certData, issueDate: e.target.value })
                }
              />
              <input
                placeholder="URL"
                value={certData.url}
                onChange={(e) =>
                  setCertData({ ...certData, url: e.target.value })
                }
              />
              <input
                type="file"
                onChange={(e) =>
                  setCertData({ ...certData, image: e.target.files[0] })
                }
              />
              <button className="btn-primary" type="submit">
                Save
              ...
              >
                ...
                {cert.hasImage && (
                  <img
                    src={
                      cert.imageUrl ||
                      `${API_BASE_URL}/certifications/${cert._id}/image`
                    }
                    alt={cert.title}
                    style={{ maxWidth: "150px", marginTop: "5px" }}
                    onError={(e) => {
